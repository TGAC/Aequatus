...
(function (h) {
    ...
    function Ha(a) {
        ...
        if (d || !r && !f && !e && j == ba(a) && j == n.length)for (m = 0; m < j; m++)i = jQuery(a, m), null !== i && (c[i].sWidth = v(n.eq(m).width())); else {
