...
function dispGenesExon(div, track, max, cigarline, ref, ref_cigar, genome) {
    ...
    while (transcript_len--) {
        ...
        if (ref) {
            ...
            dispCigarLine(cigarline, 1, top, gene_length, gene_start, stopposition, gene.transcripts[transcript_len].Exons.toJSON(), temp_div, ref.Exons.toJSON(), transcript_start, transcript_end, strand, ref_cigar, ref.strand, gene.transcripts[transcript_len].id, "style2");
...
//            }).html(gene.stable_id).appendTo(wrapper_div)
            ...
            dispCigarLineRef(cigarline, 1, top, gene_length, gene_start, stopposition, gene.transcripts[transcript_len].Exons.toJSON(), temp_div, gene.transcripts[transcript_len].Exons.toJSON(), transcript_start, transcript_end, gene.transcripts[transcript_len].id, "style2");
