    ...
    <%--<table id="dpop" width="100%">--%>
        ...
        <%--<tr>--%>
            ...
            <%--&lt;%&ndash;<td colspan="2">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<span onclick="jQuery('#d3_widget').toggle();jQuery('#widget').toggle();">Toggle View</span>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</td>&ndash;%&gt;--%>
        <%--</tr>--%>
    <%--</table>--%>
    ...
    <%--<div id="controller">--%>
        <%--<table width=100%>--%>
            <%--<tr>--%>
                ...
                <%--</td>--%>
                <%--<td>--%>
                    <%--&lt;%&ndash;<table style="position: fixed; right: 0px; top: 25px;">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<td>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<div id=export style=" display: none;"&ndash;%&gt;--%>
                                     <%--&lt;%&ndash;class="divbutton"> Export&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;</td>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<td>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<div onclick="checkSession();"&ndash;%&gt;--%>
                                     <%--&lt;%&ndash;class="divbutton">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;Save Session&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;</td>&ndash;%&gt;--%>

                            <%--&lt;%&ndash;<td>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<div id="controlsbutton" class="divbutton">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;Tracks / Settings&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;</td>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</tr>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</table>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<div id=sessionid></div>&ndash;%&gt;--%>
...
<%--<div id="searchBox" style="position: fixed; background: white; border: 1px dotted #000000; top: 45%; left: 45%">--%>
    ...
    <%--<b> Search String: </b>--%>
    <%--&lt;%&ndash;<input type="text" name="searchText" id="searchText" size="0" value="" onkeypress="return isACGT(event)"&ndash;%&gt;--%>
    <%--&lt;%&ndash;onkeyup="searchSeq();">&ndash;%&gt;--%>
...
<%--&lt;%&ndash;<div id="controlpanel_parent" style="position: fixed; width: 100px">&ndash;%&gt;--%>
<%--&lt;%&ndash;<div id="controlpanel">&ndash;%&gt;--%>

<%--&lt;%&ndash;<h1>Control Panel</h1>&ndash;%&gt;--%>

<%--&lt;%&ndash;<div class="sectionDivider" onclick="toggleLeftInfo(jQuery('#Tracksdiv_arrowclick'), 'Tracksdiv');">Tracks List&ndash;%&gt;--%>
<%--&lt;%&ndash;<div id="Tracksdiv_arrowclick" class="toggleLeftDown"></div>&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>

<%--&lt;%&ndash;<div id="Tracksdiv">&ndash;%&gt;--%>
<%--&lt;%&ndash;<table>&ndash;%&gt;--%>
<%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;<td>&ndash;%&gt;--%>
<%--&lt;%&ndash;<div id="tracklist" align="left">&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
<%--&lt;%&ndash;</td>&ndash;%&gt;--%>
<%--&lt;%&ndash;</tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;</table>&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
<%--&lt;%&ndash;<div style="position: fixed; top: 0px; height: 10px; width: 10px;" onclick="tracklistopenclose()">|||</div>&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
