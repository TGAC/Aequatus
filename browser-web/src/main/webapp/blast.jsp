...
<%--&lt;%&ndash;<h1 id="seqnameh1">Blast Search </h1>&ndash;%&gt;--%>
...
<%--<script type="text/javascript">--%>
    ...
    <%--jQuery(document).ready(function () {--%>
        ...
        <%--&lt;%&ndash;jQuery(".blasttab").html('<a href="<c:url value="index.jsp"/>"><span>Browser</span></a>');&ndash;%&gt;--%>
        <%--&lt;%&ndash;jQuery("#seqnameh1").html('<a href="<c:url value="/blast.jsp"/>"> Blast Search</a>');&ndash;%&gt;--%>
    <%--});--%>
