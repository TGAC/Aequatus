...
public interface ComparaStore extends Store<String> {
    ...
    JSONObject getGeneTreeforMember(int query, String species) throws IOException;
    ...
    Map getGeneTree(int query, String species) throws IOException;
    ...
    Map<String, Object> getGeneMemberInfofromID(int query) throws Exception;
    JSONObject findSynteny (long query, int delta) throws Exception;
    String getRefPtnStableID(int query) throws Exception;
    JSONArray findHomology(int query, String species) throws Exception;
